...
-- ----------------------------
BEGIN;
INSERT INTO `application_interface` VALUES (1, 'cross-gateway-test', 'cn.rockystudio.gateway.rpc.IActivityBooth', '活动接口', '1.0.0', '2025-11-13 13:13:00', '2025-11-13 13:13:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `application_interface_method` VALUES (1, 'cross-gateway-test', 'cn.rockystudio.gateway.rpc.IActivityBooth', 'sayHi', '测试方法', 'java.lang.String', '/wg/activity/sayHi', 'GET', 0, '2025-11-13 13:16:52', '2025-11-13 13:16:52');
INSERT INTO `application_interface_method` VALUES (2, 'cross-gateway-test', 'cn.rockystudio.gateway.rpc.IActivityBooth', 'insert', '插入方法', 'cn.rockystudio.gateway.rpc.dto.XReq', '/wg/activity/insert', 'POST', 1, '2025-11-13 13:16:52', '2025-11-13 13:16:52');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `application_system` VALUES (1, 'lottery-api', '抽奖API系统', 'RPC', 'zookeeper://192.168.1.105:2181', '2025-11-13 13:10:03', '2025-11-13 13:10:03');
INSERT INTO `application_system` VALUES (3, 'cross-gateway-test', '网关测试系统', 'RPC', 'zookeeper://192.168.1.105:2181', '2025-11-13 13:12:54', '2025-11-13 13:12:54');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gateway_distribution` VALUES (1, '10001', 'cross-gateway-g4', 'cross-gateway-test', '测试工程', '2025-11-26 13:13:00', '2025-11-26 13:13:00');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `gateway_server_detail` VALUES (13, '10001', 'cross-gateway-g1', '电商支付网关', '127.0.0.196', '1', '2025-11-06 15:22:11', '2025-11-06 15:22:11');
INSERT INTO `gateway_server_detail` VALUES (14, '10001', 'cross-gateway-g2', '电商支付网关', '127.0.0.197', '1', '2025-11-06 15:22:11', '2025-11-06 15:22:11');
INSERT INTO `gateway_server_detail` VALUES (15, '10001', 'cross-gateway-g3', '电商配送网关', '127.0.0.198', '1', '2025-11-06 15:23:19', '2025-11-06 15:23:19');
INSERT INTO `gateway_server_detail` VALUES (16, '10001', 'cross-gateway-g4', '电商配送网关', '127.0.0.1:7397', '1', '2025-12-03 15:36:19', '2025-12-03 15:36:19');
INSERT INTO `gateway_server_detail` VALUES (17, '10001', 'cross-gateway-g4', '电商配送网关', '192.168.1.105:7397', '1', '2025-12-10 11:17:11', '2025-12-10 11:17:11');
INSERT INTO `gateway_server_detail` VALUES (18, '10001', 'cross-gateway-g4', '电商配送网关', '192.168.1.105:8099', '1', '2025-12-10 12:23:04', '2025-12-10 12:23:04');
INSERT INTO `gateway_server_detail` VALUES (19, '10001', 'cross-gateway-g4', '电商配送网关', '/0:0:0:0:0:0:0:0:7399', '1', '2025-12-10 13:21:47', '2025-12-10 13:21:47');
COMMIT;
