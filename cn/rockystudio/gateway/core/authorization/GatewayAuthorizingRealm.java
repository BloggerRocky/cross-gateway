...
public class GatewayAuthorizingRealm extends AuthorizingRealm {
    ...
    public Class<?> getAuthenticationTokenClass() {
        return cn.rockystudio.gateway.core.authorization.GatewayAuthorizingToken.class;
    }
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        try {
            // 验证解析是否报错
            Claims claims = cn.rockystudio.gateway.core.authorization.JwtUtil.decode(((cn.rockystudio.gateway.core.authorization.GatewayAuthorizingToken) token).getJwt());
            // 验证签发人是否匹配
