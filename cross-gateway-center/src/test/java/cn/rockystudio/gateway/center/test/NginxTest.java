...
import static cn.rockystudio.gateway.center.test.CopyExample.unTar;
...
public class NginxTest {
    ...
    public void xx() throws Exception{
        ...
        ExecCreateCmdResponse execCreateCmdResponse = dockerClient
                .execCreateCmd(containerId)
                .withCmd("docker", "cp", "/nginx.conf", "/Users/fuzhengwei/1024/KnowledgePlanet/cross-gateway/cross-gateway-center/doc/data/nginx/")
                .exec();
    ...
    public void test_nginx_file() throws InterruptedException, IOException {
        ...
        try (TarArchiveInputStream tarStream = new TarArchiveInputStream(
                dockerClient.copyArchiveFromContainerCmd("cross-gateway-center",
                        "/nginx.conf").exec())) {
            unTar(tarStream, new File("/Users/fuzhengwei/1024/KnowledgePlanet/cross-gateway/cross-gateway-center/doc/data/nginx/nginx.conf"));
        }
        dockerClient.close();
    }
