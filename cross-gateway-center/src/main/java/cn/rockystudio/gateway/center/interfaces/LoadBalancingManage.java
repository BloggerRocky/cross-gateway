...
public class LoadBalancingManage {
    ...
    public void copy() throws IOException {
        ProcessBuilder pb = new ProcessBuilder("docker", "cp", "/nginx.conf", "host:/Users/fuzhengwei/1024/KnowledgePlanet/cross-gateway/cross-gateway-center/doc/data/nginx/nginx.conf");
        pb.start();
    }
